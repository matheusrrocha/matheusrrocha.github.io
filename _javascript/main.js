    ...
    numbers.forEach(n => {
        if(column1.includes(n)) {
            ...
            if(lastColor == "") { //initial state
                ...
                alternates = 1
                alternateColor = ""
            } else if (lastColor == "green") { //sequence of colors break alternates and reset some variables
                sequence++
                alternates = 0
                alternateColor = ""
            } else {
                if (lastColor == "blue") { //alternate color reset sequence
                    sequence = 1
                    if(alternateColor == "blue" || alternateColor == "green" || alternateColor == "") { //alternateColor keeps the color we are alternating with. If it is different, we should reset
                        alternates++
                    } else {
                        alternates = 0
                    }
                } else if (lastColor == "yellow") { //alternate color reset sequence
                    sequence = 1
        ...
        if(column2.includes(n)) {
            ...
            if(lastColor == "") { //initial state
                ...
                alternates = 1
                alternateColor = ""
            } else if (lastColor == "blue") { //sequence of colors break alternates and reset some variables
                sequence++
                alternates = 0
                alternateColor = ""
            } else {
                if (lastColor == "green") { //alternate color reset sequence
                    sequence = 1
                    if(alternateColor == "green" || alternateColor == "blue" || alternateColor == "") { //alternateColor keeps the color we are alternating with. If it is different, we should reset
                        alternates++
                    } else {
                        alternates = 0
                    }
        ...
        if(column3.includes(n)) {
            ...
            if(lastColor == "") { //initial state
                ...
                alternates = 1
                alternateColor = ""
            } else if (lastColor == "yellow") { //sequence of colors break alternates and reset some variables
                sequence++
                alternates = 0
                alternateColor = ""
            } else {
                if (lastColor == "blue") { //alternate color reset sequence
                    sequence = 1
                    if(alternateColor == "blue" || alternateColor == "yellow" || alternateColor == "") { //alternateColor keeps the color we are alternating with. If it is different, we should reset
                        alternates++
                    } else {
                        alternates = 0
                    }
                } else if (lastColor == "green") { //alternate color reset sequence
                    sequence = 1
